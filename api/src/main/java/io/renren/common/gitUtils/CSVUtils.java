...
public class CSVUtils {
    protected static final Log logger = LogFactory.getLog(CSVUtils.class);
    //行尾分隔符定义
...
//        写入内容
    ...
    public static List<List<String>> readCSV(BufferedReader bufferedReader, int colNum) {
...
//              每行的内容
    ...
    public static List<List<String>> readCSV(String filePath, int colNum) {
        ...
        return readCSV(bufferedReader, colNum);
    }
